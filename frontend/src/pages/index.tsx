...
const portfolioTokens = [
  ...
  { symbol: "TKNS", amount: 1245, usdValue: 1120.5, change: 12.5 },
...
function PortfolioOverviewCard() {
  ...
  const totalUsdValue = portfolioTokens.reduce(
      ...
      <div className="p-6 flex flex-col space-y-3">
        ...
        <div className="space-y-2 max-h-40 overflow-y-auto">
          {portfolioTokens.map((token) => (
            <div
              key={token.symbol}
              className="flex justify-between items-center text-sm p-1 border-b border-border/30"
            >
