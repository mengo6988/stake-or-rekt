...
//                       {battle.tokenA.amount} {battle.tokenA.symbol} 
//                       <span className="text-xs ml-1">(${battle.tokenA.usdValue})</span>
//                     </span>
//                     <span>vs</span>
//                     <span className="text-muted-foreground">
//                       {battle.tokenB.amount} {battle.tokenB.symbol}
//                       <span className="text-xs ml-1">(${battle.tokenB.usdValue})</span>
//                     </span>
//                   </div>
//                 </div>
//               </div>
...
//                 </div>
//                 <div className="text-xs text-muted-foreground">
//                   {battle.participants.tokenA + battle.participants.tokenB} participants
//                 </div>
//               </div>
//             </div>
//           ))}
